...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=100, unique=True, verbose_name='Project')),
                ('pdf_catalog', models.FileField(upload_to=apps.estate.models.Project.project_upload, verbose_name='PDF catalog path')),
            ],
        ),
        migrations.CreateModel(
            name='EstateImage',
